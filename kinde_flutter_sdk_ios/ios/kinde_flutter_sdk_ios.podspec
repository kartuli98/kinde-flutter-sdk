...
# Run `pod lib lint kinde_flutter_sdk_ios.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
...
IOS implementation of the flutter_inappwebview plugin.
  ...
  # s.resource_bundles = {'kinde_flutter_sdk_ios_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
end
