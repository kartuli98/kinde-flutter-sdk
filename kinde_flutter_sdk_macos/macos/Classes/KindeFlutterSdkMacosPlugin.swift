...
public class KindeFlutterSdkMacosPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "kinde_flutter_sdk_macos", binaryMessenger: registrar.messenger)
    let instance = KindeFlutterSdkMacosPlugin()
